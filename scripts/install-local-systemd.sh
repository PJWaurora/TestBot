...
EnvironmentFile=/etc/testbot/local.env
ExecStart=/root/testbot-module-bilibili/.venv/bin/python -m uvicorn bilibili_module.main:app --host 0.0.0.0 --port 8011 --no-access-log
Restart=always
RestartSec=3
User=root
...
EnvironmentFile=/etc/testbot/local.env
ExecStart=/root/testbot-module-tsperson/.venv/bin/python -m uvicorn tsperson_service.app:app --host 0.0.0.0 --port 8012 --no-access-log
Restart=always
RestartSec=3
User=root
...
EnvironmentFile=/etc/testbot/local.env
ExecStart=/root/testbot-module-weather/.venv/bin/python -m uvicorn weather_service.app:app --host 0.0.0.0 --port 8013 --no-access-log
Restart=always
RestartSec=3
User=root
...
EnvironmentFile=/etc/testbot/local.env
ExecStart=/root/TestBot/brain-python/.venv/bin/python -m uvicorn main:app --host 0.0.0.0 --port 8000 --no-access-log
Restart=always
RestartSec=3
User=root
...
EnvironmentFile=-/root/TestBot/config/modules/bilibili.env
EnvironmentFile=/etc/testbot/local.env
ExecStart=/root/testbot-media-service/.venv/bin/python -m uvicorn media_service.app:app --host 0.0.0.0 --port 8030 --no-access-log
Restart=always
RestartSec=3
User=root
